...
/**
 * \file    test/phpunit/AlbatrossFunctionalTest.php
 * \ingroup albatross
 ...
 *
 * @package Testalbatross
 */
class AlbatrossFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
    ...
    public function testModuleEnabled()
    {
        ...
        if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
            // Enable the module
            $this->byHref('modAlbatross')->click();
        } else {
            // Disable the module
            $this->byHref('modAlbatross')->click();
            // Reenable the module
    ...
    {
        $this->url('/custom/albatross/admin/setup.php');
        $this->authenticate();
        return $this->assertContains('albatross/admin/setup.php', $this->url(), 'Configuration page');
    }
    ...
    {
        $this->url('/custom/albatross/admin/about.php');
        $this->authenticate();
        return $this->assertContains('albatross/admin/about.php', $this->url(), 'About page');
    }
    ...
    public function testBoxDeclared()
    {
        ...
        $this->authenticate();
        return $this->assertContains('albatrosswidget1', $this->source(), "Box enabled");
    }
    ...
    public function testTriggerDeclared()
    {
        ...
        return $this->assertContains(
            'interface_99_modAlbatross_AlbatrossTriggers.class.php',
    ...
    public function testTriggerEnabled()
    {
        ...
        return $this->assertContains(
            'tick.png',
            $this->byXPath('//td[text()="interface_99_modAlbatross_MyTrigger.class.php"]/following::img')->attribute('src'),
            "Trigger enabled"
        );
    }
