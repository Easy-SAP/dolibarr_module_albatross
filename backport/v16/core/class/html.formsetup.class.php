...
class FormSetup
{
	...
	public function addItemFromParams($confKey, $params)
	{
		 ...
		 * 	// 'ALBATROSS_MYPARAM1'=>array('type'=>'string', 'css'=>'minwidth500' ,'enabled'=>1),
			...
			//'ALBATROSS_MYPARAM5'=>array('type'=>'yesno', 'enabled'=>1),
			//'ALBATROSS_MYPARAM5'=>array('type'=>'thirdparty_type', 'enabled'=>1),
			//'ALBATROSS_MYPARAM6'=>array('type'=>'securekey', 'enabled'=>1),
	...
	public function itemSort(
        \albatross\backport\v16\core\class\FormSetupItem $a, \albatross\backport\v16\core\class\FormSetupItem $b)
	{
		if (empty($a->rank)) {
			$a->rank = 0;
		}
